...
def find_dir(start_from, dir_name):
    """Used to find the given directory from start directory

    Arguments:
        start_from {string} -- Path to start from
        dir_name {string} -- String to look for in the starting path

    Returns:
        string -- The full path of the directory to look for
    """
